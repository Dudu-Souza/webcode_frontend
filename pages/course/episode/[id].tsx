...
const EpisodePlayer = function () {
    ...
    return (
        <>
            <Head>
                <title>WebCode - {course.episodes[episodeOrder].name}</title>
                ...
                <Container className="d-flex flex-column align-items-center gap-3 pt-5">
                    ...
                    {typeof window === "undefined" ? null : (
                        <ReactPlayer 
                            ...
                            url={`${process.env.NEXT_PUBLIC_BASEURL}/episodes/stream?videoUrl=${course.episodes[episodeOrder].videoUrl}&token=${sessionStorage.getItem("webcode-token")}`} 
                            controls 
                            ref={playerRef} 
